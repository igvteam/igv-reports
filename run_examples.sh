...
echo "fusions"
python igv_reports/report.py test/data/fusion/igv.fusion_inspector_web.json test/data/fusion/igv.genome.fa  --type fusion  --track-config test/data/fusion/tracks.json  --output examples/example_fusions.html
